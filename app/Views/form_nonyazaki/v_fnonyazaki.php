...
<div class="col-sm-12">
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">LAN Conection Check Sheet NON YAZAKI ( GUEST )</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form action="<?= site_url('Fnonyazaki') ?>/add" method="post" class="form-horizontal">
            <?= csrf_field(); ?>
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="checkbox" name="purpose_connection" value="E-mail"> E-mail
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        (1) Access Point : <input type="text" name="ac_p" class="form-control" required autofocus>
                        (2) MAC Address : <input type="text" name="mac_a" class="form-control" required autofocus>
                    </div>
                </div>
                <div class="form-group row">
